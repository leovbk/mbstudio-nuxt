...
export default {
  ...
  head: {
    ...
    meta: [
      ...
      //   content: "Margaux Bonfils, architecte d'intérieur à Charleville-Mézières, Reims et ses alentours, pour particuliers et professionnels. mbstudio-architecture.com.".replace(
      //     /<\/?[^>]+(>|$)/g,
      //     ''
      //   ),
      // },
